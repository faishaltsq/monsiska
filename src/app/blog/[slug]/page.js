      ...
      <section className='py-12 px-4 bg-white'>
        <div className='container mx-auto max-w-4xl'>
              ...
              {allArticles
                ...
                .map(relatedArticle => (
                  <Link key={relatedArticle.id} href={`/blog/${relatedArticle.slug}`}>
                    <div className='bg-gray-50 rounded-lg p-4 border border-gray-200 hover:shadow-lg transition cursor-pointer'>
          ...
          <div className='mt-16 bg-gradient-to-r from-[#1a3a52] to-[#2d5a7b] text-white rounded-lg p-8 text-center'>
            <h3 className='text-2xl font-bold mb-3'>Butuh Konsultasi Lebih Lanjut?</h3>
