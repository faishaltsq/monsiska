    ...
    <div className='pt-20'>
        ...
        <section className='relative bg-[#0f283d] text-white py-20 px-4 overflow-hidden border-b-[6px] border-[#2563eb]'>
          ...
          <div className='container mx-auto max-w-7xl text-center relative z-10'>
            ...
            <h1 className='text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 !text-white tracking-tight'>Hubungi Kami</h1>
            <p className='text-lg md:text-xl text-gray-300 font-light leading-relaxed max-w-2xl mx-auto'>
              Kami siap membantu Anda mencapai kesuksesan penelitian. Tim konsultan kami akan segera merespons pesan Anda.
            </p>
          </div>
        </section>
